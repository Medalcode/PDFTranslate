...
UPLOAD_DIR = resolve_user_path(os.getenv("UPLOAD_DIR"), "data/uploads")
OUTPUT_DIR = resolve_user_path(os.getenv("OUTPUT_DIR"), "data/outputs")
...
GLOSSARY_PATH = resolve_user_path(os.getenv("GLOSSARY_PATH"), "data/glossary.json")
